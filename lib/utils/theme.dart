...
final ThemeData myThemeLight = ThemeData(
  ...
  scaffoldBackgroundColor: Color(0xff00bcd4),
  ...
  sliderTheme: SliderThemeData(
    ...
    inactiveTrackColor: Color(0x3d3f51b5),
...
final ThemeData myThemeDark = ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    isDense: true,
    contentPadding:
        EdgeInsets.only(top: 20.0, bottom: 12.0, left: 12.0, right: 12.0),
    isCollapsed: false,
    prefixStyle: TextStyle(
      color: Color(0x80ffffff),
      fontSize: 12.0,
